...
public class Data {
    ...
    public static boolean verificaDataHoraSaidaDataHoraChegadaValida(String dataHoraInicio, String dataHoraFinal){
        LocalDateTime dataIn = converteStringEmDataHora(dataHoraInicio);
        LocalDateTime dataFim = converteStringEmDataHora(dataHoraFinal);
        
        return dataIn.isBefore(dataFim);
    }
}
